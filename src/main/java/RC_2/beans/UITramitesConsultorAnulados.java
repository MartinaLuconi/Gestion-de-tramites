...
@Named("uiTramitesConsultorAnulados")
@ViewScoped

public class UITramitesConsultorAnulados implements Serializable{
    ...
    public UITramitesConsultorAnulados() {
        try {
    ...
    public List<UITramitesConsultorGrilla> obtenerTramitesConsultorInactivos(String usuario ){
        ...
        tramitesConsultorDTO = controladorRegistrarCambioEstado.obtenerTramitesInactivos(session.getUserCod(),fechaFiltro, nombreTipoTramiteFiltro, estadoFiltro);
...
//                nombreConsultor=dtoc.getConsultorAsignado().getNombreConsultor();
    ...
    public String irATramite(int nro) {
        ...
        System.out.println("hola mundo" +nro);
